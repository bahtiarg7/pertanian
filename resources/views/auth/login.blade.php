    ...
    <div class="right-section">
        <div class="login-container">
            <form class="login-form" method="POST" action="{{ route('login') }}">
                @csrf
                <h2 class="login-title"><i class="fas fa-user-circle"></i> Dinas Pertanian Kab.Bekasi</h2>
                <div class="form-control">
                    <i class="fas fa-user icon"></i>
                    <input for="email" id="email" type="email" class="@error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="{{ __('Email Address') }}" id="username" required>
                    @error('email')
                ...
                <div class="form-control">
                    ...
                    <input for="password" id="password" placeholder="{{ __('Password') }}" type="password" class=" @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="{{ __('Password') }}" id="password" >
                    @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
...
var form = document.querySelector('{{ __('Login') }}');
